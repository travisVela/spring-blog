...
public class PostController {
    ...
    public String showAll(Model model) {
        ...
        post.setTitle(title);
        post.setBody(body);
        post2.setTitle(post2Title);
        post2.setBody(post2Body);
